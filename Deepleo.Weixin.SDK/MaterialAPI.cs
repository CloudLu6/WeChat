...
namespace Deepleo.Weixin.SDK
{
    ...
    public class MaterialAPI
    {
        ...
        public static string UploadTempMedia(string access_token, string type, string fileName, Stream inputStream)
        {
            ...
            var url = string.Format("https://qyapi.weixin.qq.com/cgi-bin/media/upload?access_token={0}&type={1}", access_token, type.ToString());
        ...
        {
            var url = string.Format("https://qyapi.weixin.qq.com/cgi-bin/media/get?access_token={0}&media_id={1}", access_token, media_id);
