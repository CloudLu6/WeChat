...
namespace Deepleo.Weixin.SDK
{
    ...
    public class ReplayActiveMessageAPI
    {
        ...
        public static bool RepayText(string access_token, string touser, string content, string kf_account = null)
        {
            ...
            return client.PostAsync(string.Format("https://qyapi.weixin.qq.com/cgi-bin/message/send?access_token={0}", access_token), new StringContent(builder.ToString())).Result.IsSuccessStatusCode;
        }
        ...
        /// <param name="kf_account">完整客服账号，格式为：账号前缀@公众号微信号</param>
        /// <returns></returns>
        public static bool RepayNews(string access_token, string touser,string agentId, WeixinNews news, string kf_account = null)
        {
            var builder = new StringBuilder();
